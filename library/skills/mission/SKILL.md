---
name: mission
description: "Create or update a PROJECT_MISSION.md for a repo — defines the north star, guiding principles, and what success looks like. Used by product-vision passes and /autonomous-sprint to prioritize work."
argument-hint: "[--bootstrap] [--edit]"
---

# Mission — Define a Project's North Star

Create or update a `PROJECT_MISSION.md` file that grounds all autonomous work in a clear direction. This doc is read by product-vision passes (clauDNA's `/claudna:product-vision`) and `/autonomous-sprint` to score and prioritize features.
...
- When a product-vision or backlog-exploration pass reports "no PROJECT_MISSION.md found" (clauDNA's `/claudna:product-vision` says this)
...
- Features a product-vision pass scored 🟢
